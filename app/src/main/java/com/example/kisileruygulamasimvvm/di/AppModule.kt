...
import com.example.kisileruygulamasimvvm.room.Veritabani
...
class AppModule {
    ...
    fun provideKisilerDao(@ApplicationContext context: Context) : KisilerDao{
        val vt = Room.databaseBuilder(context,Veritabani::class.java,"rehberkisiler.sqlite")
            .createFromAsset("rehberkisiler.sqlite").build()
